...
public class OrderConsumerDTO {
	...
	public OrderConsumerDTO(String messageName, String command, String itemName, String itemDescription,
	...
	public OrderConsumerDTO(String messageId, String messageName, String command, String itemName,
